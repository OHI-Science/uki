...
Potential power that can be obtained through renewable energies

$$
x_{ORE}=\frac{\sum_{i=1}^{N} P_{i}}{N}
$$

-$N$ = number of different types of offshore energy used
-$P$ = status weight assigned per type of energy
energies: wind, wave, tidal


$$
P=\frac{P_{t} * 100}{P_{r}}
$$

$P_{t}$ = total potential power that can be obtained
$P_{r}$ = 1000000 W / approximate power needed to power 1000 houses - sustainable secure point 
