...
```{r, child='goals/ORE.Rmd', results='asis', echo=FALSE}
```
...
```{r, echo=FALSE, warning=FALSE, error=FALSE, results="asis"}
st <- targets %>%
  filter(goal=="ORE", dimension %in% c("status", "trend")) %>%
  select(layer) %>%
  unique()
...
```{r, echo=FALSE, warning=FALSE, error=FALSE, results="asis"}
st <- targets %>%
  filter(goal=="ORE", dimension %in% c("pressure")) %>%
  select(layer) %>%
  unique()
...
```{r, echo=FALSE, warning=FALSE, error=FALSE, results="asis"}
st <- targets %>%
  filter(goal=="ORE", dimension %in% c("resilience")) %>%
  select(layer) %>%
  unique()
